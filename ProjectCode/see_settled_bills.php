...
<table class="seelist">
	<tr>
    	<th><a href="see_settled_bills.php?sort=billno">Bill No.</th>
    	<th><a href="see_settled_bills.php?sort=name">Customer Name</th>
    	<th><a href="see_settled_bills.php?sort=address">Address</th>
    	<th><a href="see_settled_bills.php?sort=billdate">Bill Date</th>
    	<th>Bill Amount</th>
    	<th>Discount</th>
    	<th>Paid Amount</th>
    	<th>Delete</th>
	...
	<?php 
		...
		while($data = mysqli_fetch_assoc($res)){
			...
			//while($data1 = mysqli_fetch_assoc($res1)){
				...
				echo("</a></td><td>".$data['address']."</td><td>".$data['bill_date']."</td><td>".round($data['amount'],2)."</td><td>".$data['discount']."</td><td>".$data['paid_amount']);
			//}
