...
// Column widths
$w = array(15, 45, 45, 30, 30, 20, 20, 20, 20);
//height
$h = 4;
// Header
...
$pdf = new PDF();
// Column headings
$header = array('Bill No.', 'Customer Name', 'Father Name', 'Village', 'Phone', 'Bill Date', 'Amount', 'Discount', 'Paid');
// Data loading
$pdf->SetFont('Arial','',10);
$pdf->AddPage('L');
$pdf->ImprovedTable($header, $conn);
//Need to look better logic to take understandable date/time
$pdf->Output("", "SettledBills_".time().".pdf", false);
?>