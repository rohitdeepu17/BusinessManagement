...
<table class="seelist">
  ...
  <?php 
		...
		while($data = mysqli_fetch_assoc($res)){
			...
			echo ("<tr><td>".$data['prod_name']."</td><td>".$data['cat_name']."</td><td>".$data['unit_cost_price']."</td><td>".$data['unit_sale_price']."</td><td>".$data['stock']."</td><td>".$data['prod_details']."</td><td><a href='delete_cat.php'><img src='delete.png' alt='' style='width:40px; height:40px;'></a></td></tr>");
		}
